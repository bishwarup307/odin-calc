...
const updateLiveDisplay = function (text) {
  ...
  if (total_digits > 17) liveCalc.style.fontSize = "1.2rem";
  else if (total_digits > 13) liveCalc.style.fontSize = "1.5rem";
  else if (total_digits > 9) liveCalc.style.fontSize = "2rem";
  else liveCalc.style = "";
